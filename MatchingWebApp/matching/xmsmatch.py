...
from xmsmatch.recognize import MicrophoneRecognizer
from argparse import RawTextHelpFormatter

warnings.filterwarnings("ignore")

DEFAULT_CONFIG_FILE = "xmsmatch.cnf.SAMPLE"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="Matcher: Audio Fingerprinting library",
    ...
    if args.fingerprint:
        ...
        if source in ('mic', 'microphone'):
            record = djv.recognize(MicrophoneRecognizer, seconds=opt_arg)
        elif source == 'file':
            record = djv.recognize(FileRecognizer, opt_arg)
        print(record)
