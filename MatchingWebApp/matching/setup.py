...
PACKAGE_NAME = "PyMatcher"
PACKAGE_VERSION = "0.1.3"
SUMMARY = 'Matcher: Audio Fingerprinting in Python'
DESCRIPTION = """
...
Matcher can memorize recorded audio by listening to it once and fingerprinting 
it. Then by playing a record and recording microphone input or on disk file, 
Matcher attempts to match the audio against the fingerprints held in the 
database, returning the record or recording being played.
...
setup(
    ...
    url='http://github.com/tuxdna/xmsmatch',
    license='MIT License',
